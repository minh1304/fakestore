export const HomeIcon = ({ width = '24px', height = '24px', className }) => (
    <svg
        ...
        width={width}
        ariaHidden="true"
        class="Svg-sc-ytk21e-0 uPxdw home-icon"
        fill="currentcolor"
        viewBox="0 0 24 24"
    >
...
export const Search = ({ width = '24px', height = '24px', className }) => (
    <svg
        className={className}
        role="img"
        height={height}
...
export const LibraryActive = ({
    ...
    <svg
        ...
        className={className}
        aria-hidden="true"
        class="Svg-sc-ytk21e-0 uPxdw collection-active-icon"
        viewBox="0 0 24 24"
        fill="currentcolor"
    >
...
export const PauseIcon = ({ width = '24px', height = '24px', className }) => (
    <svg
        role="img"
        height={height}
        width={width}
